...
//   pairmatch: `- (${promptParams.pairs} matching pairs related to the topic, with a content length limit of ${promptParams.pairLength} symbols for each part of the pair. No elements in the pairs should be repeated. Create pairs where even the incorrect matches appear plausible and do not seem absurd or obviously wrong at first glance. These pairs should create a sense of doubt and require thoughtful consideration. All items should be related to a single theme or part of the given topic so that even the incorrect matches could potentially seem correct, requiring careful evaluation to identify the right answers. If it is absolutely impossible to generate pairs strictly following the above instructions, return an empty pairmatch array.)\n`,
